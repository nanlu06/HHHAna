...
public :
   ...
   bool    mf_descend(int, int);
   double  DeltaPhi(double, double);
   double  DeltaR(double eta1, double phi1, double eta2, double phi2);
   vector<pair<double, int>> sortArr(vector<double> arr, int n);
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[135];   //[nGenPart]
   Float_t         GenPart_mass[135];   //[nGenPart]
   Float_t         GenPart_phi[135];   //[nGenPart]
   Float_t         GenPart_pt[135];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[135];   //[nGenPart]
   Int_t           GenPart_pdgId[135];   //[nGenPart]
   Int_t           GenPart_status[135];   //[nGenPart]
   Int_t           GenPart_statusFlags[135];   //[nGenPart]
   ...
   Float_t         Jet_btagDeepCvB[20];   //[nJet]
   Float_t         Jet_btagDeepCvL[20];   //[nJet]
   ...
   Float_t         Jet_chFPV0EF[20];   //[nJet]
   Float_t         Jet_chFPV1EF[20];   //[nJet]
   Float_t         Jet_chFPV2EF[20];   //[nJet]
   Float_t         Jet_chFPV3EF[20];   //[nJet]
