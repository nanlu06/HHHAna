...
{ 
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      clearTreeVectors();
      //fill event weight
      if(!datafile) genweight = genWeight*xs[samplename]*lumi/sumOfgenweight;
    ...
    */
    ...
    if(FatJetIndex.size()>=3){
        ...
        bJet1_pt = Jet_pt[bJetIndex[0]]*Jet_bRegCorr[bJetIndex[0]];
        bJet2_pt = Jet_pt[bJetIndex[bjet2_i]]*Jet_bRegCorr[bJetIndex[bjet2_i]];
        bJet3_pt = Jet_pt[bJetIndex[bjet3_i]]*Jet_bRegCorr[bJetIndex[bjet3_i]];
        bJet4_pt = Jet_pt[bJetIndex[6-bjet2_i-bjet3_i]]*Jet_bRegCorr[bJetIndex[6-bjet2_i-bjet3_i]];
        ...
        do {
            ...
            TV_b1.SetPtEtaPhiM(Jet_pt[bJetIndex[myints[0]]]*Jet_bRegCorr[bJetIndex[myints[0]]], Jet_eta[bJetIndex[myints[0]]], Jet_phi[bJetIndex[myints[0]]], Jet_mass[bJetIndex[myints[0]]]);
            TV_b2.SetPtEtaPhiM(Jet_pt[bJetIndex[myints[1]]]*Jet_bRegCorr[bJetIndex[myints[1]]], Jet_eta[bJetIndex[myints[1]]], Jet_phi[bJetIndex[myints[1]]], Jet_mass[bJetIndex[myints[1]]]);
            TV_b3.SetPtEtaPhiM(Jet_pt[bJetIndex[myints[2]]]*Jet_bRegCorr[bJetIndex[myints[2]]], Jet_eta[bJetIndex[myints[2]]], Jet_phi[bJetIndex[myints[2]]], Jet_mass[bJetIndex[myints[2]]]);
            TV_b4.SetPtEtaPhiM(Jet_pt[bJetIndex[myints[3]]]*Jet_bRegCorr[bJetIndex[myints[3]]], Jet_eta[bJetIndex[myints[3]]], Jet_phi[bJetIndex[myints[3]]], Jet_mass[bJetIndex[myints[3]]]);
            TV_b5.SetPtEtaPhiM(Jet_pt[bJetIndex[myints[4]]]*Jet_bRegCorr[bJetIndex[myints[4]]], Jet_eta[bJetIndex[myints[4]]], Jet_phi[bJetIndex[myints[4]]], Jet_mass[bJetIndex[myints[4]]]);
            TV_b6.SetPtEtaPhiM(Jet_pt[bJetIndex[myints[5]]]*Jet_bRegCorr[bJetIndex[myints[5]]], Jet_eta[bJetIndex[myints[5]]], Jet_phi[bJetIndex[myints[5]]], Jet_mass[bJetIndex[myints[5]]]);        
