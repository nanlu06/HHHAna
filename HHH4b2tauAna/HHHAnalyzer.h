...
// used to generate this class and read the Tree.
  ...
  xs["hhh4b2tau_test"] = xsHHH*BRHbb*BRHbb*BRHtautau*3.;
  xs["hhh4b2tau"] = xsHHH*BRHbb*BRHbb*BRHtautau*3.;
  ...
  sumOfgenw_2017["hhh4b2tau_test"] = 500;
  sumOfgenw_2017["hhh4b2tau"] = 28500.0;
...
void HHHAnalyzer::BookTreeBranches(){
  ...
  */
  ...
  tree->Branch("Hditau_m", &Hditau_m, "Hditau_m/F");
  tree->Branch("Hditau_pt", &Hditau_pt, "Hditau_pt/F");
  tree->Branch("Hditau_eta", &Hditau_eta, "Hditau_eta/F");
  tree->Branch("Hditau_phi", &Hditau_phi, "Hditau_phi/F");
  tree->Branch("Hfatjet_m", &Hfatjet_m, "Hfatjet_m/F");
  tree->Branch("Hfatjet_pt", &Hfatjet_pt, "Hfatjet_pt/F");
  tree->Branch("Hfatjet_eta", &Hfatjet_eta, "Hfatjet_eta/F");
  tree->Branch("Hfatjet_phi", &Hfatjet_phi, "Hfatjet_phi/F");
  tree->Branch("Hdijet1_m", &Hdijet1_m, "Hdijet1_m/F");
  tree->Branch("Hdijet1_pt", &Hdijet1_pt, "Hdijet1_pt/F");
  tree->Branch("Hdijet1_eta", &Hdijet1_eta, "Hdijet1_eta/F");
  tree->Branch("Hdijet1_phi", &Hdijet1_phi, "Hdijet1_phi/F");
  tree->Branch("Hdijet2_m", &Hdijet2_m, "Hdijet2_m/F");
  tree->Branch("Hdijet2_pt", &Hdijet2_pt, "Hdijet2_pt/F");
  tree->Branch("Hdijet2_eta", &Hdijet2_eta, "Hdijet2_eta/F");
  tree->Branch("Hdijet2_phi", &Hdijet2_phi, "Hdijet2_phi/F");
